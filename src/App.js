        ...
        return <div style={{position:"fixed",inset:0,background:"rgba(15,20,35,0.6)",display:"flex",alignItems:"flex-end",zIndex:100,backdropFilter:"blur(4px)"}} onClick={()=>setShowInjModal(false)}>
          <div onClick={e=>e.stopPropagation()} style={{width:"100%",maxWidth:390,margin:"0 auto",background:"white",borderRadius:"26px 26px 0 0",padding:"8px 16px 30px"}}>
            ...
            <div style={{marginBottom:8}}>
              ...
              <div style={{background:actSite.bg,borderRadius:12,padding:"6px",display:"flex",justifyContent:"center",alignItems:"center",border:`2px solid ${actSite.color}20`,overflow:"hidden"}}>
                <div style={{
                  transform:"scale(0.6)",
                  transformOrigin:"center center",
                  width:actSite.area==="arm"?115:185,
                  height:actSite.area==="arm"?180:actSite.area==="abdomen"?178:150,
                  display:"flex",alignItems:"center",justifyContent:"center",
                  marginTop: actSite.area==="arm"?"-50px":actSite.area==="abdomen"?"-55px":"-45px",
                  marginBottom: actSite.area==="arm"?"-50px":actSite.area==="abdomen"?"-55px":"-45px",
                }}>
